...
This repository contains the source code to define the machine learning models to predict intrinsic magnetic material properties using approximate Bayesian neural networks.
...
The source code and train dataset for the graph neural network models can be found in this GitHub repository: [heisammoustafa/Micromagnetic_GNN](https://github.com/heisammoustafa/Micromagnetic_GNN)
