...
# # Train new Magnetization model with BNN
#
...
from src.ml.bnn_special import BnnMs
...
def build_regressor(n_features: int, seed: int) -> BnnMs:
    return BnnMs(n_features=n_features, random_seed=seed)
